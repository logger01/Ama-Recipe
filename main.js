...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        firebase__WEBPACK_IMPORTED_MODULE_1__["initializeApp"]({
            apiKey: "AIzaSyDQhncj0Nnq_B7dqs4h_a9m-SBlnUYxit8",
            authDomain: "angularcomplete-4f928.firebaseapp.com"
        });
    };
...
module.exports = "<h2>Welcome to Ama's Recipe!</h2>\n"
...
var RecipeService = /** @class */ (function () {
    function RecipeService(slService) {
        ...
        this.recipes = [
            new _recipe_model__WEBPACK_IMPORTED_MODULE_2__["Recipe"]("Super Tasty MoMo", "Tibetan special dish - just awesome!", "https://upload.wikimedia.org/wikipedia/commons/6/6b/Chicken_Momo_with_spicy_hot_curry.jpg", [new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("Meat", 1), new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("chilli", 3)]),
            new _recipe_model__WEBPACK_IMPORTED_MODULE_2__["Recipe"]("Shapaley", "Go crazy after tasting this Tibetan dish", "https://s3.amazonaws.com/blogs-static.gazetadopovo.com.br/wp-content/uploads/sites/69/2017/12/2-Empanadas_Chile.jpeg", [new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("Meat", 3), new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("Soup", 2)]),
            new _recipe_model__WEBPACK_IMPORTED_MODULE_2__["Recipe"]("Thukpa", "Try to stop yourself after tasting this!", "https://i0.wp.com/media.hungryforever.com/wp-content/uploads/2016/08/26153847/chicken-thukpa-recipe.jpg?fit=934%2C700&ssl=1", [new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("Meat", 1), new _shared_ingredient_model__WEBPACK_IMPORTED_MODULE_3__["Ingredient"]("Soup", 1)])
        ];
    }
...
var DataStorageService = /** @class */ (function () {
    ...
    DataStorageService.prototype.storeRecipes = function () {
        ...
        return this.http.put('https://angularcomplete-4f928.firebaseio.com/recipes.json?auth=' + token, this.recipeService.getRecipes());
    };
    DataStorageService.prototype.getRecipes = function () {
        var _this = this;
        var token = this.authService.getToken();
        this.http.get('https://angularcomplete-4f928.firebaseio.com/recipes.json?auth=' + token)
...
module.exports = __webpack_require__(/*! E:\Angular Projects\myproject\angularcomplete\src\main.ts */"./src/main.ts");
